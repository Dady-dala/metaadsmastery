      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          lineHeight: '1.15'
            ...
            <span className="cinematic-gradient-text cinematic-text-shadow text-primary">Maîtrise Facebook & Instagram Ads et Transforme Ton Business en Machine à Ventes Automatique</span>
          </h1>
        </div>
