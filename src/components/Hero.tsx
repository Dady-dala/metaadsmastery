    ...
    try {
      ...
      if (data && !error) {
        ...
        setHeroData({
          ...
          subtitle1: data.subtitle || heroData.subtitle1,
          subtitle2: content.subtitle2 || heroData.subtitle2,
          wistiaMediaId: data.media_url || heroData.wistiaMediaId,
          ctaText: content.ctaText || heroData.ctaText,
          logosTitle: content.logosTitle || heroData.logosTitle
        });
      }
    } catch (error) {
