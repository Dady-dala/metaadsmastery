...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    const { email, token_hash, redirect_to }: PasswordResetRequest = await req.json();
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Si vous n'avez pas fait cette demande, vous pouvez ignorer ce courriel sans problème. Votre mot de passe actuel reste inchangé.</p>
            </div>
